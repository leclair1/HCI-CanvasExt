      ...
      <div className="absolute bottom-[20.83%] left-[20.83%] right-1/2 top-[20.83%]" data-name="Vector">
        <div className="absolute inset-[-7.14%_-14.29%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7 11">
            <path d={svgPaths.p12282fc0} id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33246" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/2 left-[20.83%] right-[20.83%] top-1/2" data-name="Vector_2">
        <div className="absolute inset-[-0.67px_-7.14%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 2">
            <path d="M10.3273 1H1" id="Vector_2" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33246" />
          </svg>
        </div>
      </div>
    </div>
...
function Paragraph() {
  return (
    <div className="absolute h-[20px] left-[45.99px] top-[5.99px] w-[108.177px]" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[20px] left-0 text-[14px] text-neutral-950 text-nowrap top-[0.22px] whitespace-pre">Back to Selection</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[23.993px] left-0 top-[-2px] w-[56.024px]" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-950 text-nowrap top-[-0.78px] whitespace-pre">AI Tutor</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="absolute h-[20px] left-0 top-[23.99px] w-[266.927px]" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[20px] left-0 text-[#717182] text-[14px] text-nowrap top-[0.22px] whitespace-pre">CS 101 - Introduction to Computer Science</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="absolute h-[20px] left-[199.2px] top-[5px] w-[29.583px]" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[20px] left-0 text-[14px] text-neutral-950 text-nowrap top-[0.22px] whitespace-pre">Chat</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="absolute h-[20px] left-[173.52px] top-[4.5px] w-[80.92px]" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[20px] left-0 text-[14px] text-neutral-950 text-nowrap top-[0.22px] whitespace-pre">Active Recall</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[20px] left-0 text-[14px] text-neutral-950 text-nowrap top-[0.22px] whitespace-pre">{`Hello! I'm your AI tutor for CS 101. How can I help you today?`}</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[20px] left-0 text-[14px] text-nowrap text-white top-[0.22px] whitespace-pre">Can you explain the difference between a stack and a queue?</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[180px] relative shrink-0 w-full" data-name="Paragraph">
      <div className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[20px] left-0 text-[14px] text-neutral-950 top-[0.22px] w-[540px]">
...
function TextInput() {
  return (
    <div className="absolute box-border content-stretch flex h-[20px] items-center left-[7.99px] overflow-clip px-[8px] py-0 top-[13.99px] w-[763.351px]" data-name="Text Input">
      <p className="font-['Arimo:Regular',_sans-serif] font-normal leading-[normal] relative shrink-0 text-[14px] text-[rgba(10,10,10,0.5)] text-nowrap whitespace-pre">Ask a question...</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[20px] left-0 text-[14px] text-nowrap text-white top-[0.22px] whitespace-pre">Send</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute contents inset-[8.33%_8.33%_8.35%_8.33%]" data-name="Icon">
      <div className="absolute bottom-1/4 left-1/2 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-10px_-4.167px] mask-size-[20px_20px] right-1/2 top-[20.83%]" data-name="Vector" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-7.69%_-0.83px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 13">
            <path d="M1 11.8333V1" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[37.5%_37.5%_45.83%_37.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-7.5px] mask-size-[20px_20px]" data-name="Vector_2" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-25%_-16.67%_-25.01%_-16.67%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7 6">
            <path d={svgPaths.p1fe7f100} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[72.92%] left-1/4 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-5px_-1.667px] mask-size-[20px_20px] right-1/4 top-[8.33%]" data-name="Vector_3" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-22.22%_-8.33%_-22.23%_-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 6">
            <path d={svgPaths.p32746180} id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[21.35%_12.5%_54.6%_74.99%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-14.998px_-4.271px] mask-size-[20px_20px]" data-name="Vector_4" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-17.34%_-33.29%_-17.33%_-33.3%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 7">
            <path d={svgPaths.p3035ed00} id="Vector_4" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/4 left-3/4 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-15px_-8.78px] mask-size-[20px_20px] right-[8.33%] top-[43.9%]" data-name="Vector_5" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-13.4%_-25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 9">
            <path d={svgPaths.p24f25560} id="Vector_5" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[72.85%_16.67%_8.35%_16.67%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3.333px_-14.569px] mask-size-[20px_20px]" data-name="Vector_6" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-22.16%_-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 6">
            <path d={svgPaths.p33d15d80} id="Vector_6" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/4 left-[8.33%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-1.667px_-8.78px] mask-size-[20px_20px] right-3/4 top-[43.9%]" data-name="Vector_7" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-13.4%_-25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 9">
            <path d={svgPaths.p25511dc0} id="Vector_7" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[21.35%_74.99%_54.6%_12.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-2.5px_-4.271px] mask-size-[20px_20px]" data-name="Vector_8" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-17.34%_-33.3%_-17.33%_-33.29%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 7">
            <path d={svgPaths.p306a7480} id="Vector_8" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
    </div>
...
function Paragraph9() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[30px] left-0 text-[20px] text-neutral-950 text-nowrap top-[-0.67px] whitespace-pre">Canvas Tailored</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_44_248)" id="Icon">
  ...
  return (
    <div className="basis-0 grow h-[30px] min-h-px min-w-px relative shrink-0" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[30px] relative w-full">
        <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[30px] left-0 text-[20px] text-neutral-950 text-nowrap top-[-3px] whitespace-pre">Canvas Tailored</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 grow h-[24px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-full">
        <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[24px] left-0 text-[#717182] text-[16px] text-nowrap top-[-2px] whitespace-pre">Home</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="basis-0 grow h-[24px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-full">
        <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[24px] left-0 text-[#717182] text-[16px] text-nowrap top-[-2px] whitespace-pre">Planner</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="basis-0 grow h-[24px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-full">
        <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[24px] left-0 text-[#717182] text-[16px] text-nowrap top-[-2px] whitespace-pre">Insights</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute contents inset-[8.33%_8.33%_8.35%_8.33%]" data-name="Icon">
      <div className="absolute bottom-1/4 left-1/2 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-10px_-4.167px] mask-size-[20px_20px] right-1/2 top-[20.83%]" data-name="Vector" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-7.69%_-0.83px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 13">
            <path d="M1 11.8333V1" id="Vector" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[37.5%_37.5%_45.83%_37.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-7.5px] mask-size-[20px_20px]" data-name="Vector_2" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-25%_-16.67%_-25.01%_-16.67%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7 6">
            <path d={svgPaths.p1fe7f100} id="Vector_2" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[72.92%] left-1/4 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-5px_-1.667px] mask-size-[20px_20px] right-1/4 top-[8.33%]" data-name="Vector_3" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-22.22%_-8.33%_-22.23%_-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 6">
            <path d={svgPaths.p32746180} id="Vector_3" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[21.35%_12.5%_54.6%_74.99%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-14.998px_-4.271px] mask-size-[20px_20px]" data-name="Vector_4" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-17.34%_-33.29%_-17.33%_-33.3%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 7">
            <path d={svgPaths.p3035ed00} id="Vector_4" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/4 left-3/4 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-15px_-8.78px] mask-size-[20px_20px] right-[8.33%] top-[43.9%]" data-name="Vector_5" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-13.4%_-25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 9">
            <path d={svgPaths.p24f25560} id="Vector_5" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[72.85%_16.67%_8.35%_16.67%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3.333px_-14.569px] mask-size-[20px_20px]" data-name="Vector_6" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-22.16%_-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 6">
            <path d={svgPaths.p33d15d80} id="Vector_6" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/4 left-[8.33%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-1.667px_-8.78px] mask-size-[20px_20px] right-3/4 top-[43.9%]" data-name="Vector_7" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-13.4%_-25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 9">
            <path d={svgPaths.p847be40} id="Vector_7" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[21.35%_74.99%_54.6%_12.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-2.5px_-4.271px] mask-size-[20px_20px]" data-name="Vector_8" style={{ maskImage: `url('${imgVector}')` }}>
        <div className="absolute inset-[-17.34%_-33.3%_-17.33%_-33.29%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 7">
            <path d={svgPaths.p32f73a00} id="Vector_8" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
    </div>
...
function Paragraph11() {
  return (
    <div className="h-[23.993px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',_sans-serif] font-normal leading-[24px] left-0 text-[#717182] text-[16px] text-nowrap top-[-0.78px] whitespace-pre">Flashcards</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute bottom-[16.67%] contents left-1/4 right-1/4 top-[16.67%]" data-name="Icon">
      <div className="absolute bottom-1/2 left-[33.33%] right-[33.33%] top-[16.67%]" data-name="Vector">
        <div className="absolute inset-[-12.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
            <path d={svgPaths.pc136cf0} id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[33.33%] left-1/2 right-1/2 top-1/2" data-name="Vector">
        <div className="absolute inset-[-25%_-0.83px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 6">
            <path d="M1 1V4.3333" id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/4 left-1/4 right-[62.5%] top-[58.33%]" data-name="Vector">
        <div className="absolute inset-[-25%_-33.34%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 6">
            <path d="M3.5 1L1 4.3333" id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/4 left-[62.5%] right-1/4 top-[58.33%]" data-name="Vector">
        <div className="absolute inset-[-25%_-33.34%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 6">
            <path d="M1 1L3.5 4.3333" id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[83.33%_33.33%_16.67%_33.33%]" data-name="Vector">
        <div className="absolute inset-[-0.83px_-12.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 2">
            <path d="M1 1H7.66663" id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
    </div>
